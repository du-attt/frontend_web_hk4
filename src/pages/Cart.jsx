...
const Cart = () => {
  ...
  return (
    <div className="py-2 ">
      {cart.length > 0 && (
        <h1 className="text-2xl font-bold p-3 ">Cửa hàng({cart.length} sản phẩm)</h1>
      )}
      {cart.length ? (
        ...
        <div className="h-[60vh] w-full flex flex-col items-center justify-center  gap-3 ">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold">Này, giỏ hàng của bạn có cảm giác thật nhẹ nhàng!</h2>
            <p className="text-sm text-gray-400">
              Chẳng có gì trong túi của bạn cả. Hãy thêm một số sản phẩm nào.
            </p>
          </div>
